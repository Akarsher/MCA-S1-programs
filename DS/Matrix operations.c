...
void addMatrix(int matrix1[MAX][MAX],int matrix2[MAX][MAX],int result[MAX][MAX],int rows,int cols){
    for(int i=0;i<rows;i++){
        for(int j=0;j<cols;j++){
...
void subMatrix(int matrix1[MAX][MAX],int matrix2[MAX][MAX],int result[MAX][MAX],int rows,int cols){
    for(int i=0;i<rows;i++){
        for(int j=0;j<cols;j++){
            result[i][j]=matrix1[i][j]-matrix2[i][j];
        }
...
void multiplyMatrix(int matrix1[MAX][MAX],int matrix2[MAX][MAX],int result[MAX][MAX],int rows1,int rows2,int cols1,int cols2){
